...
|---|---|
| Ask the Claude mentor about prompting, AI workflows, MCP, and Anthropic tools. Answers grounded in synced transcripts. | [your question] |
...
Glob all `.md` files under `./claude/` in the repo root.
