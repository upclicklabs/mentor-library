...
- Install for VS Code via the Extensions view (Cmd+Shift+X on Mac, Ctrl+Shift+X on Windows/Linux)
...
Sessions are not tied to a single surface. Move work between environments as your context changes:
