---
description: Ask the Chris mentor about LinkedIn strategy, content, and personal branding. Answers grounded in synced transcripts.
...
If the chris folder doesn't exist or has no `.md` files, tell the user: "No content for Chris yet. Use `/mentor-skills:research-mentor Chris [topic]` to find content, then `/mentor-skills:sync-mentor` to extract it."
